...
export default function CoursesTable({ courses, setCourses }) {
    ...
    return (
        <>
            {/* rounded-md not working */}
            <Table className="rounded-md border border-richblack-800 p-4">
                <Thead>
                    <Tr className="flex gap-x-10 rounded-t-md border-b border-b-richblack-800 px-6 py-4">
