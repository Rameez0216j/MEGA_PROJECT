...
const Home = () => {
    return (
        <div>
            {/* Section 1 */}
            <div className="relative mx-auto w-11/12 flex flex-col text-white justify-between items-center ">
                <Link to={"/signup"}>
                ...
                <div className="w-full text-center text-4xl font-semibold mt-7">
                ...
                <dir className="flex mt-8 gap-7 flex-row">
                    {/* CTA --> Call to Action */}
                ...
                <div>
                    <CodeBlocks
                        ...
                        backgroundGradient={"bg-yellow-25"}
                    />
                </div>
                ...
                <div>
                    <CodeBlocks
                        ...
                        codeblock={`<!DOCTYPE ${<span style="color:green;">Rameez Ahmad</span>} html>\n<html lang="en">\n<head>\n\t<meta charset="UTF-8">\n\t<link rel="stylesheet" href="style.css">\n\t<title>Learn New Skills</title>\n</head>\n<body>\n\t<h1><a src="skillspoint/">Learn</a></h1>\n</body>\n</html>`}
                        codeColor={"text-yellow-25"}
                        backgroundGradient={"bg-blue-25"}
                    />
                </div>
                <ExploreMore />
            </div>
            ...
            <div className="w-11/12 mx-auto max-w-maxContent flex-col items-center justify-between gap-8 first-letter bg-richblack-900 text-white">
                ...
                <h2 className="text-center text-4xl font-semobold mt-20">
